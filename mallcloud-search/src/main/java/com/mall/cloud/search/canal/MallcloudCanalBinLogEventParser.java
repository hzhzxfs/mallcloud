...
public class mallcloudCanalBinLogEventParser implements CanalBinLogEventParser {
    ...
    private mallcloudCanalBinLogEventParser() {
    }

    public static mallcloudCanalBinLogEventParser of() {
        return new mallcloudCanalBinLogEventParser();
    }
}
