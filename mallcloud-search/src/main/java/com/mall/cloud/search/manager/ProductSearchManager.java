package com.mall.cloud.search.manager;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.StrUtil;
import com.mall.cloud.api.vo.*;
import com.mall.cloud.api.vo.search.*;
...
import com.mall.cloud.search.constant.*;
...
public class ProductSearchManager {
    ...
    public List<SpuSearchVO> list(ProductSearchDTO productSearchDTO) {
        ...
        try {
            ...
            throw new mallcloudException("搜索服务出了点小差，请稍后再试", e);
        }
        return spuList;
    }
