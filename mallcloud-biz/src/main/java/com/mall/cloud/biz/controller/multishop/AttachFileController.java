package com.mall.cloud.biz.controller.multishop;


import com.mall.cloud.biz.dto.AttachFileDTO;
import com.mall.cloud.biz.model.AttachFile;
import com.mall.cloud.biz.service.AttachFileService;
import com.mall.cloud.biz.vo.AttachFileVO;
...
public class AttachFileController {
    ...
    public ServerResponseEntity<Boolean> updateFileName(@RequestBody AttachFileDTO attachFileDto) {
        if (Objects.isNull(attachFileDto.getFileName())) {
            // 图片名称不能为空
            throw new mallcloudException("图片名称不能为空");
        }
