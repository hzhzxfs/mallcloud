package com.mall.cloud.api.product.manager;
...
import com.mall.cloud.api.product.dto.ShopCartItemDTO;
...
import com.mall.cloud.api.product.vo.SpuAndSkuVO;
    ...
    public List<ShopCartVO> conversionShopCart(List<ShopCartItemVO> shopCartItems){
        ...
        for (Long shopId : shopCartMap.keySet()) {
            ...
            if (!shopNameResponse.isSuccess()) {
                throw new mallcloudException(shopNameResponse.getMsg());
            }
