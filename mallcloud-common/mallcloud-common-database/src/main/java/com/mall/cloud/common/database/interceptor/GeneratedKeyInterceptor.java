package com.mall.cloud.common.database.interceptor;

import com.mall.cloud.api.leaf.feign.SegmentFeignClient;
import com.mall.cloud.common.database.annotations.DistributedId;
...
/**
 * 分布式id生成
 * 1. 分布式id是通过美团的leaf生成的，是需要与mallcloud-leaf数据库 当中 leaf_alloc表中 biz_tag字段相关联的key
