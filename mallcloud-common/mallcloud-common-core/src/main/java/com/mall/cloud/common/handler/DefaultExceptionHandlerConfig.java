package com.mall.cloud.common.handler;
...
public class DefaultExceptionHandlerConfig {
	...
	@ExceptionHandler(mallcloudException.class)
	public ResponseEntity<ServerResponseEntity<Object>> mallcloudExceptionHandler(mallcloudException e) {
		logger.error("mallcloudExceptionHandler", e);
