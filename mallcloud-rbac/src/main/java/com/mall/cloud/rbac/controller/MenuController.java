package com.mall.cloud.rbac.controller;
...
import com.mall.cloud.common.util.BooleanUtil;
import com.mall.cloud.rbac.dto.MenuDTO;
import com.mall.cloud.rbac.model.Menu;
import com.mall.cloud.rbac.service.MenuService;
import com.mall.cloud.rbac.vo.MenuSimpleVO;
import com.mall.cloud.rbac.vo.MenuVO;
import com.mall.cloud.rbac.vo.RouteMetaVO;
import com.mall.cloud.rbac.vo.RouteVO;
...
public class MenuController {
	...
	private Menu checkAndGenerate(@RequestBody @Valid MenuDTO menuDTO) {
		...
		if(!Objects.equals(userInfoInTokenBO.getTenantId(),0L)){
			throw new mallcloudException("无权限操作！");
		}
