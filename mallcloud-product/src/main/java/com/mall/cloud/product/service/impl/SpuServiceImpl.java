...
import com.mall.cloud.api.product.bo.EsAttrBO;
import com.mall.cloud.api.product.bo.EsProductBO;
import com.mall.cloud.api.product.vo.CategoryVO;
import com.mall.cloud.api.product.vo.SpuAttrValueVO;
...
import com.mall.cloud.product.mapper.SpuMapper;
import com.mall.cloud.product.service.*;
import com.mall.cloud.api.product.vo.SpuVO;
import com.mall.cloud.product.model.Spu;
import com.mall.cloud.product.model.SpuAttrValue;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void changeSpuStatus(Long spuId, Integer status) {
        ...
        if (!Objects.equals(status, StatusEnum.ENABLE)) {
            ...
            if (!imgRes.isSuccess()) {
                throw new mallcloudException("服务异常");
            }
        }
    }
    ...
    public void deleteById(Long spuId) {
        ...
        if(Objects.isNull(spuVO) || Objects.equals(spuVO.getStatus(), StatusEnum.DELETE.value())){
            throw new mallcloudException("商品不存在或者已被删除！");
        }
        // 删除商品、sku信息(逻辑删除)
