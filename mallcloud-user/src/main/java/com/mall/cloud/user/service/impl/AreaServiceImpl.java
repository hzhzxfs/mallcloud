...
import com.mall.cloud.api.user.vo.AreaVO;
import com.mall.cloud.common.cache.constant.CacheNames;
import com.mall.cloud.common.exception.mallcloudException;
import com.mall.cloud.user.mapper.AreaMapper;
import com.mall.cloud.user.model.Area;
import com.mall.cloud.user.service.AreaService;
...
public class AreaServiceImpl implements AreaService {
    ...
    public void deleteById(Long areaId) {
        ...
        if (areaNum > 0) {
            throw new mallcloudException("请先删除子地区");
        }
